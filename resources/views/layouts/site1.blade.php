                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-3 col-12">
                            <div class="logo">
                                <a href="index-2.html"><img src="img/logo/logo.png" alt="EDUCAT"></a>
                            </div>
                        </div>
                                        ...
                                        <ul id="nav">
                                            <li class="current"><a href="index-2.html">Home</a>
                                                <ul class="sub-menu">
                                                    ...
                                                    <li><a href="index-4.html">Background Image</a></li>
                                                    <li><a href="index-5.html">Image Overlay Light</a></li>
                                                    <li><a href="index-6.html">Image Overlay Dark</a></li>
                                                    <li><a href="index-7.html">Menu With Slider</a></li>
                                                    <li><a href="index-8.html">Menu With Image</a></li>
                                                    <li><a href="index-9.html">Menu With Overlay</a></li>
                                                    <li><a href="index-10.html">Video Background</a></li>
                                                    <li><a href="index-11.html">Fixed Image</a></li>
                                                    <li><a href="index-12.html">Overlay Fixed Image</a></li>
                                                </ul>
                                            </li>
                                            ...
                                            <li><a href="index-2.html">Features</a>
                                                <ul class="sub-menu">
                                                    <li><a href="#">Sliders<i class="zmdi zmdi-chevron-left"></i></a>
                                                    ...
                                                    <li><a href="#">Menu Style<i class="zmdi zmdi-chevron-left"></i></a>
                                                        <ul class="inside-menu">
                                                    ...
                                                    <li><a href="#">Page Title<i class="zmdi zmdi-chevron-left"></i></a>
                                                        <ul class="inside-menu">
                                                    ...
                                                    <li><a href="#">Footer Style<i class="zmdi zmdi-chevron-left"></i></a>
                                                        <ul class="inside-menu">
                                ...
                                <div class="col-md-12">
                                    <div class="text-content-wrapper">
                                        <div class="text-content">
                                            ...
                                            <p class="sub-title wow fadeInUp d-none d-lg-block" data-wow-duration="2900ms" data-wow-delay=".5s"> There are many variations of passages of Lorem Ipsum available, but the majority have<br>
                                    ...
                                    <div class="text-content-wrapper">
                                        <div class="text-content slide-2">
                                            <h1 class="title1 wow rotateInDownLeft" data-wow-duration="1000ms" data-wow-delay="0s">Education Needs<br>
                                                Complete Solution</h1>
                                            <p class="sub-title wow rotateInDownLeft d-none d-lg-block" data-wow-duration="1800ms" data-wow-delay="0s"> There are many variations of passages of Lorem Ipsum available, but the majority have<br>
                                                suffered alteration in some form, by injected humour, or randomised words which<br>
                                                don't look even slightly believable.</p>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 text-center">
                        <a href="#" class="button-default button-large">Browse All Courses <i class="zmdi zmdi-chevron-left"></i></a>
                    </div>
                </div>
            </div>
        </div>
...
<!-- jquery
============================================ -->
<script src="{{asset('assets/css/js/vendor/jquery-1.12.4.min.js')}}"></script>

<!-- popper JS
============================================ -->
<script src="{{asset('assets/css/js/popper.min.js')}}"></script>
...
<!-- AJax Mail JS
============================================ -->
<script src="{{asset('assets/css/js/ajax-mail.js')}}"></script>

<!-- plugins JS
============================================ -->
<script src="{{asset('assets/css/js/plugins.js')}}"></script>

<!-- StyleSwitch JS
============================================ -->
<script src="{{asset('assets/css/js/styleswitch.js')}}"></script>
