                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('admin.mainparnters')}}"> الزكلات الدوليه </a>
                                </li>
                                <li class="breadcrumb-item active">إضافة الوكلاء الدولين
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> إضافة الوكلاء الدولين </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.mainparnters.store')}}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="form-body">
                                                <h4 class="form-section"><i class="ft-home"></i> بيانات  الوكلات </h4>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea  class="form-control"       id="placeTextarea" rows="10"  name="description" type="text"   placeholder="ادخل الوصف المتاسب للموضوع."    >{{Request::old('description')}}</textarea>
                                                    @error('description')
                                                    <span class="text-danger">{{$message}} </span>
                                                    @enderror
                                                </div>
