                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('admin.Services')}}"> أللغات </a>
                                </li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.Services.update',$Services -> id)}}"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control"
                                                              ...
                                                              type="text"
                                                              placeholder="ادخل الوصف.">{{$Services -> description_en}}</textarea>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"   value="{{$Services -> model}}" id="name"
                                                                   class="form-control"
                                                                   placeholder="ادخل  اسم الايقونه
"
                                                                   name="model">
                                                            @error('title_en')
                                                            <span class="text-danger">{{$message}}</span>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="form-group">
                                                                <div class="text-center">
                                                                    <img src="{{asset($Services -> image)}}" class="rounded-circle  height-150" style="" alt="صورة الوكيل  ">
                                                                </div>
                                                            </div>
