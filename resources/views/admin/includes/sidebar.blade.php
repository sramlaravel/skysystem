        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item active"><a href=""><i class="la la-mouse-pointer"></i><span
                ...
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.dashboard')}}"
                                          data-i18n="nav.dash.ecommerce"> الصفحه الرتيسية </a>
                    </li>
                    {{--<li><a class="menu-item" href="{{route('admin.dashboard')}}" data-i18n="nav.dash.crypto">أضاف اسلايد جديد </a>--}}
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item  open ">
                <a href=""><i class="la la-home"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">اسلايدات الموقع</span>
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="{{route('admin.languages.create')}}" data-i18n="nav.dash.crypto">أضاف اسلايد جديد </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item  open ">
                <a href=""><i class="la la-home"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">حول شركه انجاز شوفت</span>
                    <span  class="badge badge badge-info badge-pill float-right mr-2">{{App\Models\Language::count()}} </span>
                </a>
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="{{route('admin.about.create')}}" data-i18n="nav.dash.crypto">أضاف كلام جدبد جديد </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                    ...
                    <span
                        class="badge badge badge-danger badge-pill float-right mr-2">{{App\Models\Services::count()}}</span>
                </a>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.Services')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.Services.create')}}" data-i18n="nav.dash.crypto">أضافة
                            خدمه جديده </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item  open ">
                <a href=""><i class="la la-home"></i>
                    ...
                    <span  class="badge badge badge-info badge-pill float-right mr-2">{{App\Models\item::count()}} </span>
                </a>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.maincategories')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.maincategories.create')}}" data-i18n="nav.dash.crypto">أضاف كلام جدبد جديد </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item  open ">
                <a href=""><i class="la la-home"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">الانظمه</span>
                    <span  class="badge badge badge-info badge-pill float-right mr-2">{{App\Models\Apps::count()}} </span>
                </a>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.items')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.items.create')}}" data-i18n="nav.dash.crypto">أضاف نانظمه جديده  جديد </a>
                    </li>
                </ul>
            </li>

            {{--<li class="nav-item"><a href=""><i class="la la-group"></i>--}}
                    {{--<span class="menu-title" data-i18n="nav.dash.main">وجبة الصبوح </span>--}}

                    {{--<span     class="badge badge badge-danger badge-pill float-right mr-2">{{App\Models\Breackfast::count()}}</span>--}}
                {{--</a>--}}
                {{--<ul class="menu-content">--}}
                    {{--<li class="active"><a class="menu-item" href="{{route('admin.Breackfast')}}"--}}
                                          {{--data-i18n="nav.dash.ecommerce"> عرض الكل </a>--}}
                    {{--</li>--}}
                    {{--<li><a class="menu-item" href="{{route('admin.Breackfast.create')}}" data-i18n="nav.dash.crypto">أضافة وجبه جديده </a>--}}
                    {{--</li>--}}
                {{--</ul>--}}
            {{--</li>--}}
            ...
            {{--<li class="nav-item"><a href=""><i class="la la-group"></i>--}}
                    {{--<span class="menu-title" data-i18n="nav.dash.main">وجبة الغداء </span>--}}

                    {{--<span     class="badge badge badge-danger badge-pill float-right mr-2">{{App\Models\Lunch::count()}}</span>--}}
                {{--</a>--}}
                {{--<ul class="menu-content">--}}
                    {{--<li class="active"><a class="menu-item" href="{{route('admin.Lunches')}}"--}}
                                          {{--data-i18n="nav.dash.ecommerce"> عرض الكل </a>--}}
                    {{--</li>--}}
                    {{--<li><a class="menu-item" href="{{route('admin.Lunches.create')}}" data-i18n="nav.dash.crypto">أضافة وجبه جديده </a>--}}
                    {{--</li>--}}
                {{--</ul>--}}
            {{--</li>--}}
            ...
            {{--<li class="nav-item"><a href=""><i class="la la-group"></i>--}}
                    {{--<span class="menu-title" data-i18n="nav.dash.main">وجبة العشاء </span>--}}

                    {{--<span     class="badge badge badge-danger badge-pill float-right mr-2">{{App\Models\Dinner::count()}}</span>--}}
                {{--</a>--}}
                {{--<ul class="menu-content">--}}
                    {{--<li class="active"><a class="menu-item" href="{{route('admin.Dinner')}}"--}}
                                          {{--data-i18n="nav.dash.ecommerce"> عرض الكل </a>--}}
                    {{--</li>--}}
                    {{--<li><a class="menu-item" href="{{route('admin.Dinner.create')}}" data-i18n="nav.dash.crypto">أضافة وجبه جديده </a>--}}
                    {{--</li>--}}
                {{--</ul>--}}
            {{--</li>--}}
            ...
            {{--<li class="nav-item"><a href=""><i class="la la-group"></i>--}}
                    ...
                    {{--<span     class="badge badge badge-danger badge-pill float-right mr-2">{{App\Models\Customer::count()}}</span>--}}
                {{--</a>--}}
                {{--<ul class="menu-content">--}}
                    {{--<li class="active"><a class="menu-item" href="{{route('admin.Customer')}}"--}}
                                          {{--data-i18n="nav.dash.ecommerce"> عرض الكل </a>--}}
                    {{--</li>--}}
                    {{--<li><a class="menu-item" href="{{route('admin.Customer.create')}}" data-i18n="nav.dash.crypto">أضافة خدمه جديده </a>--}}
                    {{--</li>--}}
                {{--</ul>--}}
            {{--</li>--}}
            ...
            {{--<li class="nav-item"><a href=""><i class="la la-group"></i>--}}
                    {{--<span class="menu-title" data-i18n="nav.dash.main">شهاده عملانا </span>--}}

                    {{--<span     class="badge badge badge-danger badge-pill float-right mr-2">{{App\Models\Opnoin::count()}}</span>--}}
                {{--</a>--}}
                {{--<ul class="menu-content">--}}
                    {{--<li class="active"><a class="menu-item" href="{{route('admin.opinion')}}"--}}
                                          {{--data-i18n="nav.dash.ecommerce"> عرض الكل </a>--}}
                    {{--</li>--}}
                    {{--<li><a class="menu-item" href="{{route('admin.opinion.create')}}" data-i18n="nav.dash.crypto">أضافة رأي جديد </a>--}}
                    {{--</li>--}}
                {{--</ul>--}}
            {{--</li>--}}

            {{--<li class="nav-item"><a href=""><i class="la la-group"></i>--}}
                    {{--<span class="menu-title" data-i18n="nav.dash.main">الوكالات الدواليه  </span>--}}
                    {{--<span  class="badge badge badge-success badge-pill float-right mr-2"> </span>--}}
                {{--</a>--}}
                {{--<ul class="menu-content">--}}
                    {{--<li class="active"><a class="menu-item" href="{{route('admin.mainparnters')}}"--}}
                                          {{--data-i18n="nav.dash.ecommerce"> عرض الكل </a>--}}
                    {{--</li>--}}
                    {{--<li><a class="menu-item" href="{{route('admin.mainparnters.create')}}" data-i18n="nav.dash.crypto">أضافة وكالات جديده </a>--}}
                    {{--</li>--}}
                {{--</ul>--}}
            {{--</li>--}}
            ...
            {{--<li class="nav-item"><a href=""><i class="la la-male"></i>--}}
                ...
                {{--<ul class="menu-content">--}}
                    {{--<li class="active"><a class="menu-item" href="{{route('admin.branches')}}"--}}
                                          {{--data-i18n="nav.dash.ecommerce"> عرض الكل </a>--}}
                    {{--</li>--}}
                    {{--<li><a class="menu-item" href="{{route('admin.branches.create')}}" data-i18n="nav.dash.crypto">أضافة فرع جديد</a>--}}
                    {{--</li>--}}
                {{--</ul>--}}
            {{--</li>--}}
            ...
            {{--<li class="nav-item">--}}
                {{--<a href=""><i class="la la-male"></i>--}}
                    {{--<span class="menu-title" data-i18n="nav.dash.main">نقاط الخدمه</span>--}}
                    {{--<span--}}
                            {{--class="badge badge badge-danger  badge-pill float-right mr-2"> </span>--}}
                {{--</a>--}}
                {{--<ul class="menu-content">--}}
                    {{--<li class="active"><a class="menu-item" href="{{route('admin.ServicePoint')}}"--}}
                                          {{--data-i18n="nav.dash.ecommerce">عرض الكل </a>--}}
                    {{--</li>--}}
                    {{--</li>--}}
                    {{--<li><a class="menu-item" href="{{route('admin.ServicePoint.create')}}" data-i18n="nav.dash.crypto">أضافة نقطه جديده </a>--}}
                    {{--</li>--}}
                {{--</ul>--}}
            {{--</li>--}}
            ...
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">الاخبار الجديده  </span>
                    <span
                        class="badge badge badge-warning  badge-pill float-right mr-2">{{App\Models\Comenews::count()}} </span>
                </a>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.comenew')}}      "
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.comenew.create')}}" data-i18n="nav.dash.crypto">أضافة خبر جديده </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">الوظائف </span>
                    <span
                             class="badge badge badge-warning  badge-pill float-right mr-2">{{App\Models\Jobs::count()}}</span>
                </a>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.Jobs')}}      "
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.Jobs.create')}}" data-i18n="nav.dash.crypto">أضافة وظيفه جديده </a>
                    </li>
                </ul>
            </li>
</ul>
