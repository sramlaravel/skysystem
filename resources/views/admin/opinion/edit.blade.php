                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href=""> الاراء الرئيسية </a>
                                </li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> تعديل رأي العميل </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.opinion.update', $mainCategory -> id)}}"  method="POST"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section">
                                                    <i class="ft-home"></i> شهاده عملائنا </h4>
                                                <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 ">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="projectinput1"> ماذا يقوب العميل عنا  </label>

                                                                    <textarea  class="form-control"  id="placeTextarea" rows="3"  name="description" type="text"   placeholder="ادخل الوصف."    >{{$mainCategory -> description}}</textarea>
                                                                    @error('description')
