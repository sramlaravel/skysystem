                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">إضافة نقطه  خدمه
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> إضافة نقطه  خدمه </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.ServicePoint.store')}}"
                                              method="POST"
                                            ...
                                            <div class="row">
                                                            ...
                                                            <optgroup >
                                                                @if($countries && $countries -> count() > 0)
                                                                    @foreach($countries  as $country=>$key )
                                                                        <option value="من فضلك أختر الدوله ">من فضلك أختر الدوله </option>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="city_id"  value="" class="select2 form-control" >
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{Request::old('name_point')}} "
                                                                   id="name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="name_point">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="placeTextarea" rows="3"
                                                                      ...
                                                                      placeholder="ادخل الوصف.">{{Request::old('desc_ar')}} </textarea>
                                                            @error('desc_ar')
                                                            <span class="text-danger">{{$message}} </span>
                                                            @enderror
                                                        </div>
