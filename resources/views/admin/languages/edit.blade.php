                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.languages.update',$slider -> id)}}" method="POST"enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea     class="form-control"    value="{{Request::old('description_ar')}}"   id="placeTextarea" rows="3"  name="description_ar" type="text"   placeholder="ادخل الوصف."    >{{$slider -> description_ar}}</textarea>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea     class="form-control"    value="{{Request::old('description_en')}}"   id="placeTextarea" rows="3"  name="description_en" type="text"   placeholder="ادخل الوصف."    >{{$slider -> description_en}}</textarea>
