                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> تعديل الخدمه </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.Customer.update', $mainCategory -> id)}}"  method="POST"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section">
                                                    <i class="ft-home"></i> بيانات الخدمة </h4>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> اسم الخدمة
                                                             </label>
