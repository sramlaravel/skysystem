                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> إضافة فرع </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.branches.store')}}"
                                              method="POST"
                                              enctype="multipart/form-data">


                                            <label for="projectinput1"> خط العرض  </label>
                                            <input type="text"  value="" id="latitude" name="lat">
                                            <label for="projectinput1"> خط الطول  </label>
                                            <input type="text" value="" id="longitude"  name="lng">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value=" {{Request::old('location_name_ar')}}" id="name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                ...
                                                <div class="row">
                                                    <div class="class col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="location_type" value="{{Request::old('location_type')}}"
                                                                   class="form-control"
