<div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            {{--<li class="nav-item  open ">--}}
                {{--<a href=""><i class="la la-home"></i>--}}
                    {{--<span class="menu-title" data-i18n="nav.dash.main">اسعار العملات</span>--}}
                    {{--<span  class="badge badge badge-info badge-pill float-right mr-2">{{App\Models\Language::count()}} </span>--}}
                {{--</a>--}}
                {{--<ul class="menu-content">--}}
                    {{--<li class="active"><a class="menu-item" href="{{route('admin.currency')}}"--}}
                                          {{--data-i18n="nav.dash.ecommerce"> عرض الكل </a>--}}
                    {{--</li>--}}
                    {{--<li><a class="menu-item" href="{{route('admin.currency.create')}}" data-i18n="nav.dash.crypto">أضاف عمله  جديد </a>--}}
                    {{--</li>--}}
                {{--</ul>--}}
            {{--</li>--}}
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                    ...
                    <span     class="badge badge badge-danger badge-pill float-right mr-2">{{App\Models\Services::count()}}</span>
                </a>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.mainservice')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.mainservice.create')}}" data-i18n="nav.dash.crypto">أضافة خدمه جديده </a>
                    </li>
                </ul>
            </li>

            <li class="nav-item"><a href=""><i class="la la-group"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">الزكالات الدواليه  </span>
                    <span  class="badge badge badge-success badge-pill float-right mr-2">{{App\Models\Partners::count()}}</span>
                </a>
                <ul class="menu-content">
            ...
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                    ...
                    <span  class="badge badge badge-success badge-pill float-right mr-2">{{App\Models\branches::count()}}</span>
                </a>
                <ul class="menu-content">
            ...
            <li class="nav-item">
                <a href=""><i class="la la-male"></i>
                    ...
                    <span
                            class="badge badge badge-danger  badge-pill float-right mr-2">{{App\Models\points::count()}}</span>
                </a>
                <ul class="menu-content">
